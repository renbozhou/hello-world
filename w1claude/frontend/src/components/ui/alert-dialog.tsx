...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn('rounded bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn('rounded border px-4 py-2 text-sm font-medium hover:bg-gray-50', className)}
    {...props}
  />
))
